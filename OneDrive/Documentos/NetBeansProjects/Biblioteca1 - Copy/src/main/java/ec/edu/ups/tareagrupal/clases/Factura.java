...
public class Factura {
    ...
    public Factura(String id, double baseImponible, byte impuestos, int descuento, double costoTotal) {
        this.id = id;
    ...
    public byte getImpuestos() {
        return impuestos;
    }

    public void setImpuestos(byte impuestos) {
        this.impuestos = impuestos;
    }
